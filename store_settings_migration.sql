...
VALUES (1, 'Ketronics LTD', 'Tech Products & Expert Services', 'info@ketronics.co.ke', '+254 XXX XXX XXX', 'AA building 1st floor room F6A', 'KES', 'Africa/Nairobi', false, true, true, true, ARRAY['mpesa', 'card'], ARRAY['standard', 'express'], 16.00, 5000.00)
