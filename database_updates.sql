...
('about-us', 'About Us', '<h1>About Ketronics LTD</h1><p>We are a leading technology company specializing in laptops, printers, TVs, PCs and expert tech services including maintenance, repairs, CCTV installation, and network setup. With years of experience in the Kenyan market, we provide reliable products and professional services to homes and businesses.</p><p>Our mission is to make technology accessible and affordable while providing exceptional customer support. We stock genuine products from trusted brands and our certified technicians ensure all installations and repairs are done to the highest standards.</p>', 'About Us - Ketronics LTD', 'Learn more about Ketronics LTD, our mission, vision, and commitment to excellence in technology products and services.'),
('terms-and-conditions', 'Terms and Conditions', '<h1>Terms and Conditions</h1><p>By using our services, you agree to comply with and be bound by the following terms and conditions of use. These terms apply to your use of our website and all products and services offered by Ketronics LTD.</p><h2>Product Purchases</h2><p>All sales are final unless the product is defective. We offer warranties on all our products as specified by the manufacturer.</p><h2>Services</h2><p>Service appointments must be scheduled in advance. Cancellation fees may apply for late cancellations.</p>', 'Terms and Conditions - Ketronics LTD', 'Read our terms and conditions for using Ketronics LTD services and purchasing products.'),
('privacy-policy', 'Privacy Policy', '<h1>Privacy Policy</h1><p>We respect your privacy and are committed to protecting your personal information. This privacy policy explains how we collect, use, and safeguard your data when you use our services.</p><h2>Information We Collect</h2><p>We collect information you provide directly to us, such as when you create an account, make a purchase, or contact us for support.</p><h2>How We Use Your Information</h2><p>We use your information to process orders, provide customer support, and improve our services.</p>', 'Privacy Policy - Ketronics LTD', 'Learn about how we protect and handle your personal information at Ketronics LTD.'),
('support', 'Customer Support', '<h1>Customer Support</h1><p>Get help with your orders and products. Our dedicated support team is here to assist you with any questions or issues you may have.</p><h2>Contact Methods</h2><p>You can reach us through our contact form, phone, email, or visit our physical location. We aim to respond to all inquiries within 24 hours.</p><h2>Common Topics</h2><ul><li>Order status and tracking</li><li>Product information and specifications</li><li>Warranty claims</li><li>Technical support</li><li>Return and exchange requests</li></ul>', 'Support - Ketronics LTD', 'Get help and support for your Ketronics LTD products and services.')
